...
- [ ] **Step 1: 失敗するテストを書く（changeset 拡張・enum・age）**
...
- [ ] **Step 2: cast_assoc / drop_blank の失敗テストを書く**
...
- [ ] **Step 6: `ServiceUser` に has_many + cast_assoc を追加**
...
- [ ] **Step 7: `Plans.drop_blank_certificates/1` を実装**
...
- [ ] **Step 5（Task 6 完了後に実行）: テスト確認 → コミット**は Task 6 の末尾でまとめて行う。
...
- [ ] **Step 4: フォーム + Index のテストが通ることを確認**

Run: `mix test test/ayumi_web/live/service_user_live_test.exs`
Expected: PASS（Task 5 の導線テストもここで緑になる）

- [ ] **Step 5: コミット（Task 5 + Task 6 をまとめて）**
