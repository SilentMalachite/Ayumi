...
- [ ] **Step 2: Wrap each Japanese literal**
...
- [ ] **Step 3: Verify GREEN + clean compile**
...
- [ ] **Step 2: Wrap the Elixir-body strings**
...
- [ ] **Step 3: Wrap the interpolated presence banner (L153)**
...
- [ ] **Step 4: Wrap the section headers (HEEx body)**
...
- [ ] **Step 5: Wrap the input labels (attributes)**
...
- [ ] **Step 6: Wrap the three prompts and the save button**
...
- [ ] **Step 7: Verify GREEN + clean compile**
...
- [ ] **Step 2: Wrap the section headers (HEEx body)**

For each `<h2 class="text-lg font-semibold mb-2">X</h2>`, change `X` → `{gettext("X")}`, with X ∈:
`基本` (L36), `連絡先` (L44), `受給者証` (L60), `障害者手帳` (L73), `医療` (L90), `その他` (L99), `支援計画` (L108).

- [ ] **Step 3: Wrap the body text nodes / button / link**
...
- [ ] **Step 4: Wrap the `field_row` labels (attributes)**
...
- [ ] **Step 5: Wrap the table `:col` labels (attributes)**
...
- [ ] **Step 6: Wrap the interpolated `format_birthdate/2` helper (L140)**
...
- [ ] **Step 3: Wrap the HEEx body, labels, prompt, button**
...
- [ ] **Step 4: Verify GREEN + clean compile**
...
- [ ] **Step 3: Wrap the mixed-interpolation subtitle (L47)**
...
- [ ] **Step 4: Wrap the remaining body text, item titles, col label, input label, button**
...
- [ ] **Step 5: Verify GREEN + clean compile**
...
- [ ] **Step 1: Confirm no inline Japanese remains in the in-scope files**
...
- [ ] **Step 2: Generate the POT manifest**
...
- [ ] **Step 3: Confirm the POT is in sync with the code**
